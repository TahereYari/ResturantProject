...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('panel/dist/css/adminlte-rtl.min.css') }}">
</head>
<!--
`body` tag options:
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('resturant-list') }}" class="nav-link {{ request()->is ('admin/resturant/*') ? 'active':'' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Resturants</p>
                </a>
              </li>
...
<script src={{ asset("panel/plugins/jquery/jquery-rtl.min.js") }}></script>
<!-- Bootstrap 4 -->
{{-- <script src=<{{ asset("panel/plugins/bootstrap/js/bootstrap.bundle.min.js") }}></script> --}}
<script src=<{{ asset("panel/plugins/bootstrap/js/bootstrap-rtl.bundle.min.js") }}></script>
<!-- DataTables  & Plugins -->
{{-- <script src={{ asset("panel/plugins/datatables/jquery.dataTables.min.js") }}></script> --}}
<script src={{ asset("panel/plugins/datatables/jquery-rtl.dataTables.min.js") }}></script>

{{-- <script src={{ asset("panel/plugins/datatables-bs4/js/dataTables.bootstrap4.min.js") }}></script> --}}
<script src={{ asset("panel/plugins/datatables-bs4/js/dataTables-rtl.bootstrap4.min.js") }}></script>

{{-- <script src={{ asset("panel/plugins/datatables-responsive/js/dataTables.responsive.min.js") }}></script> --}}
<script src={{ asset("panel/plugins/datatables-responsive/js/dataTables-rtl.responsive.min.js") }}></script>
